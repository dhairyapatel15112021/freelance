...
export const Information = () => {
  return (
    <div className='h-full w-full flex flex-col justify-center items-center mt-10'>
        <button className='font-monserrat font-light text-black bg-light-pink py-2 px-4 w-fit rounded-sm flex justify-center items-center gap-x-2 text-xl cursor-pointer'>
