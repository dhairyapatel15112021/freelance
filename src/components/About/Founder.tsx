...
export const Founder = (inputData : data) => {
  ...
  return (
    <div className="w-[100%] md:w-[40%] flex flex-col justify-evenly gap-2 md:gap-0 mt-6 md:mt-0">
        ...
        <div className="font-poppins text-base md:text-lg font-light md:font-medium">{inputData.name}</div>
        <div className="font-poppins text-sm md:text-base font-extralight md:font-light">{inputData.description}</div>
        <div className="font-poppins text-sm md:text-base font-light md:font-medium">Connect</div>
    </div>
  )
}
