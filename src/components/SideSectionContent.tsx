...
export const SideSectionContent = (inputdata: data) => {
  ...
  return (
    <section id={inputdata.id} className="h-[100vh] w-[100%] relative md:bg-none bg-gradient-to-b from-black from-[40%] to-[#666666]">
      ...
      <div className={`absolute left-[0vw] md:left-[40vw] opacity-20 w-[100vw] md:w-[60vw] h-[100vh] ${inputdata.index === 0 ? `bg-decor` : inputdata.index === 1 ? `bg-specialEffects` : `bg-choreo`} bg-right md:bg-center bg-cover`}></div>
      {
        isMobile && 
