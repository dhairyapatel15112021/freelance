  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center mt-20">
        <div className="w-[80vw] text-left md:text-center font-monserrat font-extralight md:font-light text-sm md:text-base">
      ...
      <div className="flex flex-col justify-center items-center mt-20">
        <div className="w-[80vw]">
          <div className="text-left md:text-center font-great-vibes tracking-[0.3rem] font-medium text-4xl md:text-5xl">Meet the Founders</div>
        </div>
      ...
      <div className="flex justify-center items-center mt-10 md:mt-20">
        <div className="w-[80vw] font-monserrat font-light text-black bg-light-pink py-2 px-4 rounded-sm text-center text-xs md:text-base">
